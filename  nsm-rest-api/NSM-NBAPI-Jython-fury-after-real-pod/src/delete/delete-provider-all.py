...
if __name__ == '__main__':
    ...
    myProvider.create('011')
    myProviderDetailXml = myProvider.getDetail('111')
    myProviderCatalogXml = myProvider.getCatalog('211')
    ...
    myGlobalIpAddressPool.getAllocated()
    myGlobalIpAddressPool.getAvailable()
    myGlobalIpAddressPool.getReservations()
    '''
    ...
    myInfrastructureIpAddressPool.getAllocated()
    myInfrastructureIpAddressPool.getAvailable()
    myInfrastructureIpAddressPool.getReservations()
