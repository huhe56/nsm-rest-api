...
class TestSimple(Test):
    ...
    #__online1,  __online101, __online2, __online3, __online4, __online5 = False, True, True, True, True, True
    __online1,  __online101, __online2, __online3, __online4, __online5 = False, False, True, True, True, True
    ...
    def start(self):
        ...
        pod = self.run(catalog, 'test-pod-full-101.json', TestSimple.__online101)       
                                                    
                                                    
                                                               
        if TestSimple.__online101: 
